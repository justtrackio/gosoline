...
type BaseShareHandler[K mdl.PossibleIdentifier, M Shareable[K]] interface {
	...
	TransformOutput(ctx context.Context, model M, apiView string) (output interface{}, err error)
}
...
func AddShareCreateHandler[I Metadata, K mdl.PossibleIdentifier, M Shareable[K]](logger log.Logger, d *apiserver.Definitions, version int, basePath string, handler ShareCreateHandler[I, K, M]) {
