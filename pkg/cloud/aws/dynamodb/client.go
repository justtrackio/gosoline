...
func NewClient(ctx context.Context, config cfg.Config, logger mon.Logger, name string, optFns ...func(options *awsCfg.LoadOptions) error) (*dynamodb.Client, error) {
...
func NewClientWithInterfaces(ctx context.Context, config cfg.Config, logger mon.Logger, clock clock.Clock, settings *Settings, optFns ...func(options *awsCfg.LoadOptions) error) (*dynamodb.Client, error) {
	var err error
