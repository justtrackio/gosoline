...
// Reader_Source_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Source'
type Reader_Source_Call struct {
	*mock.Call
}

// Source is a helper method to define mock.On call
func (_e *Reader_Expecter) Source() *Reader_Source_Call {
	return &Reader_Source_Call{Call: _e.mock.On("Source")}
}

func (_c *Reader_Source_Call) Run(run func()) *Reader_Source_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Reader_Source_Call) Return(_a0 string) *Reader_Source_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Reader_Source_Call) RunAndReturn(run func() string) *Reader_Source_Call {
	_c.Call.Return(run)
	return _c
}
