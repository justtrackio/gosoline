...
func (s *loggingMiddlewareTestSuite) TestRequestCanceledError() {
	...
	_ = ginCtx.Error(context.Canceled) //nolint:errcheck // just returns the error passed as an argument
...
func (s *loggingMiddlewareTestSuite) TestEOFError() {
	...
	_ = ginCtx.Error(io.EOF) //nolint:errcheck // just returns the error passed as an argument
...
func (s *loggingMiddlewareTestSuite) TestBindError() {
	...
	_ = ginCtx.Error(&gin.Error{ //nolint:errcheck // just returns the error passed as an argument
...
func (s *loggingMiddlewareTestSuite) TestDefaultError() {
	...
	_ = ginCtx.Error(fmt.Errorf("error")) //nolint:errcheck // just returns the error passed as an argument
...
func TestLogFields(t *testing.T) {
	...
	clock.EXPECT().Now().Return(now.Add(1 * time.Second)).Once()
