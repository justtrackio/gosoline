...
func NewBaseUpdateHandler[I interface{}, K mdl.PossibleIdentifier, M db_repo.ModelBased[K]](t mockConstructorTestingTNewBaseUpdateHandler) *BaseUpdateHandler[I, K, M] {
