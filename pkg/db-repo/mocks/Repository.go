...
// BatchCreate provides a mock function with given fields: ctx, values
func (_m *Repository) BatchCreate(ctx context.Context, values interface{}) error {
...
// BatchDelete provides a mock function with given fields: ctx, values
func (_m *Repository) BatchDelete(ctx context.Context, values interface{}) error {
	ret := _m.Called(ctx, values)
...
// BatchUpdate provides a mock function with given fields: ctx, values
func (_m *Repository) BatchUpdate(ctx context.Context, values interface{}) error {
	ret := _m.Called(ctx, values)
