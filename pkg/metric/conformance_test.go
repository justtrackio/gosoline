...
var authoredNames = []authoredName{
	{NamespaceMessaging, "process.duration", UnitMilliseconds, kindHistogram, true},
	{NamespaceMessaging, "client.consumed.messages", UnitCount, kindCounter, true},
	{NamespaceMessaging, "client.sent.messages", UnitCount, kindCounter, true},
	{NamespaceMessaging, "client.operation.duration", UnitMilliseconds, kindHistogram, true},

	{NamespaceStreamConsumer, "errors", UnitCount, kindCounter, false},
	{NamespaceStreamConsumer, "retry.operations", UnitCount, kindCounter, false},
	{NamespaceStreamProducer, "messages", UnitCount, kindCounter, false},
	{NamespaceStreamProducer, "batch.size", UnitCount, kindHistogram, false},
	{NamespaceStreamProducer, "aggregate.size", UnitCount, kindHistogram, false},
	{NamespaceStreamProducer, "idle.duration", UnitMilliseconds, kindHistogram, false},
	{NamespaceStreamInput, "available.messages", UnitCount, kindGauge, false},
	{NamespaceStreamOutput, "sent.messages", UnitCount, kindCounter, false},
	{NamespaceStreamInputRedisList, "message.count", UnitCount, kindGauge, false},
	{NamespaceStreamInputRedisList, "reads", UnitCount, kindCounter, false},
	{NamespaceStreamOutputRedisList, "writes", UnitCount, kindCounter, false},

	{NamespaceAutoscalingPerRunner, "stream.messages", UnitCount, kindGauge, false},
	{NamespaceAutoscalingPerRunner, "http.server.requests", UnitCount, kindGauge, false},

	{NamespaceKafkaConsumer, "polls", UnitCount, kindCounter, false},
	{NamespaceKafkaConsumer, "poll.duration", UnitMilliseconds, kindHistogram, false},
	{NamespaceKafkaConsumer, "commit.duration", UnitMilliseconds, kindHistogram, false},
	{NamespaceKafkaConsumer, "commit.errors", UnitCount, kindCounter, false},
	{NamespaceKafkaConsumer, "wait.duration", UnitMilliseconds, kindHistogram, false},
	{NamespaceKafkaConsumer, "rebalances", UnitCount, kindCounter, false},
	{NamespaceKafkaConsumer, "consume.errors", UnitCount, kindCounter, false},
	{NamespaceKafkaProducer, "batch.size", UnitCount, kindHistogram, false},
	{NamespaceKafkaProducer, "send.errors", UnitCount, kindCounter, false},

	{NamespaceKafkaBroker, "connects", UnitCount, kindCounter, false},
	{NamespaceKafkaBroker, "throttles", UnitCount, kindCounter, false},
	{NamespaceKafkaBroker, "throttle.duration", UnitMilliseconds, kindHistogram, false},
	{NamespaceKafkaBroker, "produce.batch.records", UnitCount, kindHistogram, false},
	{NamespaceKafkaBroker, "produce.batch.size", UnitBytes, kindHistogram, false},
	{NamespaceKafkaBroker, "produce.batch.compressed.size", UnitBytes, kindHistogram, false},
	{NamespaceKafkaBroker, "fetch.batch.records", UnitCount, kindHistogram, false},
	{NamespaceKafkaBroker, "fetch.batch.size", UnitBytes, kindHistogram, false},
	{NamespaceKafkaBroker, "fetch.batch.compressed.size", UnitBytes, kindHistogram, false},

	{NamespaceAwsKinesisShard, "reads", UnitCount, kindCounter, false},
	{NamespaceAwsKinesisShard, "consume.errors", UnitCount, kindCounter, false},
	{NamespaceAwsKinesisShard, "lag", UnitMilliseconds, kindGauge, false},
	{NamespaceAwsKinesisShard, "acquire.delay", UnitSeconds, kindHistogram, false},
	{NamespaceAwsKinesisShard, "sleep.duration", UnitMilliseconds, kindHistogram, false},
	{NamespaceAwsKinesisShard, "wait.duration", UnitMilliseconds, kindHistogram, false},
	{NamespaceAwsKinesisConsumer, "shard.count", UnitCount, kindGauge, false},
	{NamespaceAwsKinesisConsumer, "client.count", UnitCount, kindGauge, false},
	{NamespaceAwsKinesisProducer, "batch.size", UnitCount, kindHistogram, false},
	{NamespaceAwsKinesisProducer, "send.errors", UnitCount, kindCounter, false},

	{NamespaceKvStore, "reads", UnitCount, kindCounter, false},
	{NamespaceKvStore, "writes", UnitCount, kindCounter, false},
	{NamespaceKvStore, "deletes", UnitCount, kindCounter, false},
	{NamespaceKvStore, "hits", UnitCount, kindCounter, false},
	{NamespaceKvStore, "item.count", UnitCount, kindGauge, false},

	{NamespaceDbClient, "connection.count", UnitCount, kindGauge, true},
	{NamespaceDbClient, "connections", UnitCount, kindCounter, false},
	{NamespaceDbClient, "operation.duration", UnitMilliseconds, kindHistogram, true},
	{NamespaceDbRepo, "model_event.notifications", UnitCount, kindCounter, false},
	{NamespaceDbRepo, "model_event.notify.errors", UnitCount, kindCounter, false},

	{NamespaceMdlSub, "consumed.events", UnitCount, kindCounter, false},
	{NamespaceMdlSub, "skipped.events", UnitCount, kindCounter, false},
	{NamespaceMdlSub, "consume.errors", UnitCount, kindCounter, false},

	{NamespaceHttpServer, "request.duration", UnitMilliseconds, kindHistogram, true},
	{NamespaceHttpServer, "rejected.requests", UnitCount, kindCounter, false},
	{NamespaceHttpServer, "active_requests", UnitCount, kindGauge, true},
	{NamespaceHttpServer, "connection.count", UnitCount, kindGauge, false},
	{NamespaceHttpClient, "request.duration", UnitMilliseconds, kindHistogram, true},
	{NamespaceRpcServer, "duration", UnitMilliseconds, kindHistogram, true},

	{NamespaceBlob, "batch.operations", UnitCount, kindCounter, false},
	{NamespaceConcScheduler, "batch.size", UnitCount, kindHistogram, false},
	{NamespaceConcScheduler, "task.delay", UnitMilliseconds, kindHistogram, false},
	{NamespaceLimit, "rate_limit.takes", UnitCount, kindCounter, false},
	{NamespaceLimit, "rate_limit.releases", UnitCount, kindCounter, false},
	{NamespaceLimit, "rate_limit.throttles", UnitCount, kindCounter, false},
	{NamespaceLimit, "rate_limit.errors", UnitCount, kindCounter, false},
	{NamespaceSmpl, "decisions", UnitCount, kindCounter, false},
	{NamespaceLog, "records", UnitCount, kindCounter, false},
}
...
func TestAuthoredNamesDeriveTheirOtelUnit(t *testing.T) {
	expected := map[string]string{
		...
		"stream.consumer.errors":                      "{error}",
		"stream.consumer.retry.operations":            "{operation}",
		"stream.producer.messages":                    "{message}",
		"stream.producer.batch.size":                  "1",
		"stream.producer.aggregate.size":              "1",
		"stream.producer.idle.duration":               "s",
		"stream.input.available.messages":             "{message}",
		"stream.output.sent.messages":                 "{message}",
		"stream.input.redis_list.message.count":       "1",
		"stream.input.redis_list.reads":               "{read}",
		"stream.output.redis_list.writes":             "{write}",
		...
		"kafka.broker.connects":                       "{connect}",
		"kafka.broker.throttles":                      "{throttle}",
		"kafka.broker.throttle.duration":              "s",
		"kafka.broker.produce.batch.records":          "{record}",
		"kafka.broker.produce.batch.size":             "By",
		"kafka.broker.produce.batch.compressed.size":  "By",
		"kafka.broker.fetch.batch.records":            "{record}",
		"kafka.broker.fetch.batch.size":               "By",
		"kafka.broker.fetch.batch.compressed.size":    "By",
		"aws.kinesis.shard.reads":                     "{read}",
		"aws.kinesis.shard.consume.errors":            "{error}",
		"aws.kinesis.shard.lag":                       "s",
		"aws.kinesis.shard.acquire.delay":             "s",
		"aws.kinesis.shard.sleep.duration":            "s",
		"aws.kinesis.shard.wait.duration":             "s",
		"aws.kinesis.consumer.shard.count":            "1",
		"aws.kinesis.consumer.client.count":           "1",
		"aws.kinesis.producer.batch.size":             "1",
		"aws.kinesis.producer.send.errors":            "{error}",
		"kvstore.reads":                               "{read}",
		...
		"db.repo.model_event.notify.errors":           "{error}",
