...
var authoredNames = []authoredName{
	...
	{NamespaceStream, "errors", UnitCount, kindCounter, false},
	{NamespaceStream, "retry.operations", UnitCount, kindCounter, false},
	{NamespaceStream, "messages", UnitCount, kindCounter, false},
	{NamespaceStream, "batch.size", UnitCount, kindHistogram, false},
	{NamespaceStream, "aggregate.size", UnitCount, kindHistogram, false},
	{NamespaceStream, "idle.duration", UnitMilliseconds, kindHistogram, false},
	{NamespaceStream, "available.messages", UnitCount, kindGauge, false},
	{NamespaceStream, "sent.messages", UnitCount, kindCounter, false},
	{NamespaceStream, "message.count", UnitCount, kindGauge, false},
	{NamespaceStream, "reads", UnitCount, kindCounter, false},
	{NamespaceStream, "writes", UnitCount, kindCounter, false},
	...
	{NamespaceKafka, "connects", UnitCount, kindCounter, false},
	{NamespaceKafka, "throttles", UnitCount, kindCounter, false},
	{NamespaceKafka, "throttle.duration", UnitMilliseconds, kindHistogram, false},
	{NamespaceKafka, "produce.batch.records", UnitCount, kindHistogram, false},
	{NamespaceKafka, "produce.batch.size", UnitBytes, kindHistogram, false},
	{NamespaceKafka, "produce.batch.compressed.size", UnitBytes, kindHistogram, false},
	{NamespaceKafka, "fetch.batch.records", UnitCount, kindHistogram, false},
	{NamespaceKafka, "fetch.batch.size", UnitBytes, kindHistogram, false},
	{NamespaceKafka, "fetch.batch.compressed.size", UnitBytes, kindHistogram, false},

	{NamespaceCloudAwsKinesis, "reads", UnitCount, kindCounter, false},
	{NamespaceCloudAwsKinesis, "consume.errors", UnitCount, kindCounter, false},
	{NamespaceCloudAwsKinesis, "lag", UnitMilliseconds, kindGauge, false},
	{NamespaceCloudAwsKinesis, "acquire.delay", UnitSeconds, kindHistogram, false},
	{NamespaceCloudAwsKinesis, "sleep.duration", UnitMilliseconds, kindHistogram, false},
	{NamespaceCloudAwsKinesis, "wait.duration", UnitMilliseconds, kindHistogram, false},
	{NamespaceCloudAwsKinesis, "shard.count", UnitCount, kindGauge, false},
	{NamespaceCloudAwsKinesis, "client.count", UnitCount, kindGauge, false},
	{NamespaceCloudAwsKinesis, "batch.size", UnitCount, kindHistogram, false},
	{NamespaceCloudAwsKinesis, "send.errors", UnitCount, kindCounter, false},
	...
	{NamespaceMetric, "records", UnitCount, kindCounter, false},
}
