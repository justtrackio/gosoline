...
func (_m *GosoConf) FormatString(pattern string, args ...map[string]string) (string, error) {
...
// GosoConf_FormatString_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FormatString'
type GosoConf_FormatString_Call struct {
	*mock.Call
}
...
func (_e *GosoConf_Expecter) FormatString(pattern interface{}, args ...interface{}) *GosoConf_FormatString_Call {
	return &GosoConf_FormatString_Call{Call: _e.mock.On("FormatString",
		append([]interface{}{pattern}, args...)...)}
}

func (_c *GosoConf_FormatString_Call) Run(run func(pattern string, args ...map[string]string)) *GosoConf_FormatString_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *GosoConf_FormatString_Call) Return(_a0 string, _a1 error) *GosoConf_FormatString_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *GosoConf_FormatString_Call) RunAndReturn(run func(string, ...map[string]string) (string, error)) *GosoConf_FormatString_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *GosoConf) UnmarshalDefaults(val interface{}, additionalDefaults ...cfg.UnmarshalDefaults) error {
...
func (_c *GosoConf_UnmarshalDefaults_Call) Return(_a0 error) *GosoConf_UnmarshalDefaults_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GosoConf_UnmarshalDefaults_Call) RunAndReturn(run func(interface{}, ...cfg.UnmarshalDefaults) error) *GosoConf_UnmarshalDefaults_Call {
	_c.Call.Return(run)
	return _c
}

// UnmarshalKey provides a mock function with given fields: key, val, additionalDefaults
func (_m *GosoConf) UnmarshalKey(key string, val interface{}, additionalDefaults ...cfg.UnmarshalDefaults) error {
	_va := make([]interface{}, len(additionalDefaults))
	for _i := range additionalDefaults {
		_va[_i] = additionalDefaults[_i]
	}
...
func (_c *GosoConf_UnmarshalKey_Call) Return(_a0 error) *GosoConf_UnmarshalKey_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GosoConf_UnmarshalKey_Call) RunAndReturn(run func(string, interface{}, ...cfg.UnmarshalDefaults) error) *GosoConf_UnmarshalKey_Call {
	_c.Call.Return(run)
	return _c
}
