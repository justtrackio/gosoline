...
func (_m *Cache[T]) Stop() {
	_m.Called()
}

// Cache_Stop_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Stop'
type Cache_Stop_Call[T interface{}] struct {
	*mock.Call
}

// Stop is a helper method to define mock.On call
func (_e *Cache_Expecter[T]) Stop() *Cache_Stop_Call[T] {
	return &Cache_Stop_Call[T]{Call: _e.mock.On("Stop")}
}

func (_c *Cache_Stop_Call[T]) Run(run func()) *Cache_Stop_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Cache_Stop_Call[T]) Return() *Cache_Stop_Call[T] {
	_c.Call.Return()
	return _c
}

func (_c *Cache_Stop_Call[T]) RunAndReturn(run func()) *Cache_Stop_Call[T] {
	_c.Run(run)
	return _c
}
