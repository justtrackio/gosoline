...
// Write provides a mock function with given fields: ctx, fixture
func (_m *FixtureWriter) Write(ctx context.Context, fixture *fixtures.FixtureSet) error {
	ret := _m.Called(ctx, fixture)
...
//   - ctx context.Context
//   - fixture *fixtures.FixtureSet
func (_e *FixtureWriter_Expecter) Write(ctx interface{}, fixture interface{}) *FixtureWriter_Write_Call {
	return &FixtureWriter_Write_Call{Call: _e.mock.On("Write", ctx, fixture)}
}

func (_c *FixtureWriter_Write_Call) Run(run func(ctx context.Context, fixture *fixtures.FixtureSet)) *FixtureWriter_Write_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *FixtureWriter_Write_Call) RunAndReturn(run func(context.Context, *fixtures.FixtureSet) error) *FixtureWriter_Write_Call {
	_c.Call.Return(run)
	return _c
}
