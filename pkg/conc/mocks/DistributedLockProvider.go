...
// TryAcquireIn provides a mock function with given fields: ctx, resource, timeout
func (_m *DistributedLockProvider) TryAcquireIn(ctx context.Context, resource string, timeout time.Duration) (conc.DistributedLock, error) {
	ret := _m.Called(ctx, resource, timeout)

	if len(ret) == 0 {
		panic("no return value specified for TryAcquireIn")
	}

	var r0 conc.DistributedLock
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, time.Duration) (conc.DistributedLock, error)); ok {
		return rf(ctx, resource, timeout)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, time.Duration) conc.DistributedLock); ok {
		r0 = rf(ctx, resource, timeout)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(conc.DistributedLock)
		}
...
// DistributedLockProvider_TryAcquireIn_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'TryAcquireIn'
type DistributedLockProvider_TryAcquireIn_Call struct {
	*mock.Call
}

// TryAcquireIn is a helper method to define mock.On call
//   - ctx context.Context
//   - resource string
//   - timeout time.Duration
func (_e *DistributedLockProvider_Expecter) TryAcquireIn(ctx interface{}, resource interface{}, timeout interface{}) *DistributedLockProvider_TryAcquireIn_Call {
	return &DistributedLockProvider_TryAcquireIn_Call{Call: _e.mock.On("TryAcquireIn", ctx, resource, timeout)}
}

func (_c *DistributedLockProvider_TryAcquireIn_Call) Run(run func(ctx context.Context, resource string, timeout time.Duration)) *DistributedLockProvider_TryAcquireIn_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DistributedLockProvider_TryAcquireIn_Call) Return(_a0 conc.DistributedLock, _a1 error) *DistributedLockProvider_TryAcquireIn_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DistributedLockProvider_TryAcquireIn_Call) RunAndReturn(run func(context.Context, string, time.Duration) (conc.DistributedLock, error)) *DistributedLockProvider_TryAcquireIn_Call {
	_c.Call.Return(run)
	return _c
}
