...
// AcquireIfNotInUse provides a mock function with given fields: ctx, resource
func (_m *DistributedLockProvider) AcquireIfNotInUse(ctx context.Context, resource string) (conc.DistributedLock, error) {
	ret := _m.Called(ctx, resource)
...
// DistributedLockProvider_AcquireIfNotInUse_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AcquireIfNotInUse'
type DistributedLockProvider_AcquireIfNotInUse_Call struct {
	*mock.Call
}

// AcquireIfNotInUse is a helper method to define mock.On call
//   - ctx context.Context
//   - resource string
func (_e *DistributedLockProvider_Expecter) AcquireIfNotInUse(ctx interface{}, resource interface{}) *DistributedLockProvider_AcquireIfNotInUse_Call {
	return &DistributedLockProvider_AcquireIfNotInUse_Call{Call: _e.mock.On("AcquireIfNotInUse", ctx, resource)}
}

func (_c *DistributedLockProvider_AcquireIfNotInUse_Call) Run(run func(ctx context.Context, resource string)) *DistributedLockProvider_AcquireIfNotInUse_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *DistributedLockProvider_AcquireIfNotInUse_Call) Return(_a0 conc.DistributedLock, _a1 error) *DistributedLockProvider_AcquireIfNotInUse_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DistributedLockProvider_AcquireIfNotInUse_Call) RunAndReturn(run func(context.Context, string) (conc.DistributedLock, error)) *DistributedLockProvider_AcquireIfNotInUse_Call {
	_c.Call.Return(run)
	return _c
}
