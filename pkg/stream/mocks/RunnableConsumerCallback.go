...
func (_c *RunnableConsumerCallback_Consume_Call) Run(run func(ctx context.Context, model interface{}, attributes map[string]interface{})) *RunnableConsumerCallback_Consume_Call {
...
func (_c *RunnableConsumerCallback_Consume_Call) RunAndReturn(run func(context.Context, interface{}, map[string]interface{}) (bool, error)) *RunnableConsumerCallback_Consume_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *RunnableConsumerCallback_GetModel_Call) Run(run func(attributes map[string]interface{})) *RunnableConsumerCallback_GetModel_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RunnableConsumerCallback_GetModel_Call) RunAndReturn(run func(map[string]interface{}) interface{}) *RunnableConsumerCallback_GetModel_Call {
	_c.Call.Return(run)
	return _c
}
