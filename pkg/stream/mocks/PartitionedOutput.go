...
// IsPartitionedOutput provides a mock function with no fields
...
func (_m *PartitionedOutput) ProvidesCompression() bool {
	ret := _m.Called()
...
// PartitionedOutput_ProvidesCompression_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ProvidesCompression'
type PartitionedOutput_ProvidesCompression_Call struct {
	*mock.Call
}

// ProvidesCompression is a helper method to define mock.On call
func (_e *PartitionedOutput_Expecter) ProvidesCompression() *PartitionedOutput_ProvidesCompression_Call {
	return &PartitionedOutput_ProvidesCompression_Call{Call: _e.mock.On("ProvidesCompression")}
}

func (_c *PartitionedOutput_ProvidesCompression_Call) Run(run func()) *PartitionedOutput_ProvidesCompression_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *PartitionedOutput_ProvidesCompression_Call) Return(_a0 bool) *PartitionedOutput_ProvidesCompression_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PartitionedOutput_ProvidesCompression_Call) RunAndReturn(run func() bool) *PartitionedOutput_ProvidesCompression_Call {
	_c.Call.Return(run)
	return _c
}

// SupportsAggregation provides a mock function with no fields
func (_m *PartitionedOutput) SupportsAggregation() bool {
	ret := _m.Called()
...
// PartitionedOutput_SupportsAggregation_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SupportsAggregation'
type PartitionedOutput_SupportsAggregation_Call struct {
	*mock.Call
}

// SupportsAggregation is a helper method to define mock.On call
func (_e *PartitionedOutput_Expecter) SupportsAggregation() *PartitionedOutput_SupportsAggregation_Call {
	return &PartitionedOutput_SupportsAggregation_Call{Call: _e.mock.On("SupportsAggregation")}
}

func (_c *PartitionedOutput_SupportsAggregation_Call) Run(run func()) *PartitionedOutput_SupportsAggregation_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *PartitionedOutput_SupportsAggregation_Call) Return(_a0 bool) *PartitionedOutput_SupportsAggregation_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PartitionedOutput_SupportsAggregation_Call) RunAndReturn(run func() bool) *PartitionedOutput_SupportsAggregation_Call {
	_c.Call.Return(run)
	return _c
}
