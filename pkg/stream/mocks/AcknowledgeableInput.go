...
// NewAcknowledgeableInput creates a new instance of AcknowledgeableInput. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAcknowledgeableInput(t testing.TB) *AcknowledgeableInput {
