...
// ReturnAllNew provides a mock function with no fields
...
// ReturnUpdatedNew provides a mock function with no fields
...
// ReturnUpdatedOld provides a mock function with no fields
...
// SetOperand provides a mock function with given fields: path, op
func (_m *UpdateItemBuilder) SetOperand(path string, op expression.OperandBuilder) ddb.UpdateItemBuilder {
	ret := _m.Called(path, op)

	if len(ret) == 0 {
		panic("no return value specified for SetOperand")
	}

	var r0 ddb.UpdateItemBuilder
	if rf, ok := ret.Get(0).(func(string, expression.OperandBuilder) ddb.UpdateItemBuilder); ok {
		r0 = rf(path, op)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ddb.UpdateItemBuilder)
...
// UpdateItemBuilder_SetOperand_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetOperand'
type UpdateItemBuilder_SetOperand_Call struct {
	*mock.Call
}

// SetOperand is a helper method to define mock.On call
//   - path string
//   - op expression.OperandBuilder
func (_e *UpdateItemBuilder_Expecter) SetOperand(path interface{}, op interface{}) *UpdateItemBuilder_SetOperand_Call {
	return &UpdateItemBuilder_SetOperand_Call{Call: _e.mock.On("SetOperand", path, op)}
}

func (_c *UpdateItemBuilder_SetOperand_Call) Run(run func(path string, op expression.OperandBuilder)) *UpdateItemBuilder_SetOperand_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(expression.OperandBuilder))
	})
	return _c
}

func (_c *UpdateItemBuilder_SetOperand_Call) Return(_a0 ddb.UpdateItemBuilder) *UpdateItemBuilder_SetOperand_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *UpdateItemBuilder_SetOperand_Call) RunAndReturn(run func(string, expression.OperandBuilder) ddb.UpdateItemBuilder) *UpdateItemBuilder_SetOperand_Call {
	_c.Call.Return(run)
	return _c
}
