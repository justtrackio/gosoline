...
func (_m *KafkaMessageHandler) Handle(message kgo.Record) {
	_m.Called(message)
}
...
//   - message kgo.Record
func (_e *KafkaMessageHandler_Expecter) Handle(message interface{}) *KafkaMessageHandler_Handle_Call {
	return &KafkaMessageHandler_Handle_Call{Call: _e.mock.On("Handle", message)}
}

func (_c *KafkaMessageHandler_Handle_Call) Run(run func(message kgo.Record)) *KafkaMessageHandler_Handle_Call {
