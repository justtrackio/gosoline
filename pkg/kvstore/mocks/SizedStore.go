...
func (_m *SizedStore) Contains(ctx context.Context, key interface{}) (bool, error) {
...
func (_m *SizedStore) Delete(ctx context.Context, key interface{}) error {
	ret := _m.Called(ctx, key)
...
func (_m *SizedStore) DeleteBatch(ctx context.Context, keys interface{}) error {
...
func (_m *SizedStore) EstimateSize() *int64 {
	ret := _m.Called()
...
func (_m *SizedStore) Get(ctx context.Context, key interface{}, value interface{}) (bool, error) {
...
func (_m *SizedStore) GetBatch(ctx context.Context, keys interface{}, values interface{}) ([]interface{}, error) {
...
func (_m *SizedStore) Put(ctx context.Context, key interface{}, value interface{}) error {
	ret := _m.Called(ctx, key, value)
...
func (_m *SizedStore) PutBatch(ctx context.Context, values interface{}) error {
...
func NewSizedStore(t mockConstructorTestingTNewSizedStore) *SizedStore {
	mock := &SizedStore{}
	mock.Mock.Test(t)
