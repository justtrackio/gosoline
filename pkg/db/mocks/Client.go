...
// ExecMultiInTx provides a mock function with given fields: ctx, sqllers
func (_m *Client) ExecMultiInTx(ctx context.Context, sqllers ...db.Sqller) ([]sql.Result, error) {
	_va := make([]interface{}, len(sqllers))
	for _i := range sqllers {
		_va[_i] = sqllers[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, ctx)
	...
	var r0 []sql.Result
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...db.Sqller) ([]sql.Result, error)); ok {
		return rf(ctx, sqllers...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...db.Sqller) []sql.Result); ok {
		r0 = rf(ctx, sqllers...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]sql.Result)
	...
	if rf, ok := ret.Get(1).(func(context.Context, ...db.Sqller) error); ok {
		r1 = rf(ctx, sqllers...)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - sqllers ...db.Sqller
func (_e *Client_Expecter) ExecMultiInTx(ctx interface{}, sqllers ...interface{}) *Client_ExecMultiInTx_Call {
	return &Client_ExecMultiInTx_Call{Call: _e.mock.On("ExecMultiInTx",
		append([]interface{}{ctx}, sqllers...)...)}
}

func (_c *Client_ExecMultiInTx_Call) Run(run func(ctx context.Context, sqllers ...db.Sqller)) *Client_ExecMultiInTx_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]db.Sqller, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
				variadicArgs[i] = a.(db.Sqller)
			}
		}
...
func (_c *Client_ExecMultiInTx_Call) RunAndReturn(run func(context.Context, ...db.Sqller) ([]sql.Result, error)) *Client_ExecMultiInTx_Call {
	_c.Call.Return(run)
	return _c
}
