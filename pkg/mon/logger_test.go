...
func TestClient_WithFields(t *testing.T) {
	...
	expected := `{"fields":{"field1":"a","field2":1,"time_field": "2020-01-31T11:54:47+01:00"},"context":{},"channel": "default", "level":2,"level_name":"info","message":"foobar","timestamp":"1984-04-04T00:00:00Z"}`
	assert.JSONEq(t, expected, out.String(), "output should match")
	...
	expected = `{"fields":{"field1":"a","field2":1,"time_field": "2020-01-31T11:54:47+01:00","field3":0.3},"context":{},"channel": "default", "level":2,"level_name":"info","message":"msg2","timestamp":"1984-04-04T00:00:00Z"}`
	assert.JSONEq(t, expected, out.String(), "output should match")
