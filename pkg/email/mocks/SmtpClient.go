...
// SendMail provides a mock function with given fields: from, to, r
func (_m *SmtpClient) SendMail(from string, to []string, r io.Reader) error {
	ret := _m.Called(from, to, r)
...
//   - to []string
//   - r io.Reader
func (_e *SmtpClient_Expecter) SendMail(from interface{}, to interface{}, r interface{}) *SmtpClient_SendMail_Call {
	return &SmtpClient_SendMail_Call{Call: _e.mock.On("SendMail", from, to, r)}
}

func (_c *SmtpClient_SendMail_Call) Run(run func(from string, to []string, r io.Reader)) *SmtpClient_SendMail_Call {
