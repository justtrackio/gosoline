...
Creates a new UPDATE query builder. You can provide a map with the new values. You can use the `Where` method to add conditions to your query. The `Exec` method executes the query.
