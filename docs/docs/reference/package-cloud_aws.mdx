...
to get the default `cloudwatch` client. You don't have to provide any configuration
...
These are the default values which are used if you don't provide any configuration by yourself.
