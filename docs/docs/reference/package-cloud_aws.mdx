...
| credentials_cache.expiry_window             | The duration before cached credentials expire                                     | 5m                            |
| credentials_cache.expiry_window_jitter_frac | The fraction of the expiry window to use as jitter                                | 0.1                           |
