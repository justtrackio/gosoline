...
import MinimumLogger from "!!raw-loader!./src/minimal-logger.go";
import LoggerConfig from "!!raw-loader!./src/config-logger.yml";
import ConfigLogger from "!!raw-loader!./src/config-logger.go";
