...
Every Gosoline application has an **AppIdentity** consisting of:
...
Naming patterns use macro placeholders that are automatically resolved from your AppIdentity:
...
2. **Gosoline resolves placeholders** from AppIdentity and service-specific context
