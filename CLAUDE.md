...
**YOU ARE IN: `gosoline/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/gosoline/` (rig root) or other directories
...
**Your mail address:** `gosoline/polecats/furiosa`
**Your rig:** gosoline
**Your Witness:** `gosoline/witness`
...
| Ask Witness for help | `gt mail send gosoline/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`gosoline/witness`) when:
...
```bash
gt mail send gosoline/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
